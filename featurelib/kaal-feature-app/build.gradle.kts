...
dependencies {
    ...
    /*implementation(project(":codebase:codebase-domain"))
    implementation(project(":codebase:codebase-data"))
    implementation(project(":codebase:codebase-infrastructure"))*/
    ...
    // Google
    implementation(Dependencies.AndroidX.supportFragment)
